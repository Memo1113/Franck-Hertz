...
import pandas as pd
df = pd.read_csv('https://raw.githubusercontent.com/Memo1113/Intermedia/main/Valles.csv', header=0, sep=';')
...
print('Los voltajes promedio de los valles son:\n',Media)
...
plt.suptitle(r'$Valles$',fontsize=24,color='r')
...
print('\nLas distancias consecutivas de los valles son:\n',d)
...
plt.suptitle(r'$Distancias\;entre\;valles$',fontsize=24,color='r')
plt.xlabel(r'$N°$',fontsize=12,color='blue')
...
for i in range(n-1,n+1):
    a=d[-1]
    b=I[i-1]
    plt.text(i-0.05, d[i-1],"{}{}{}". format(a,c,b),ha='right',va='center',fontsize=8,color='b')
plt.show()
